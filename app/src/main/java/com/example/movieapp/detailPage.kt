...
class detailPage : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val user = intent.getParcelableExtra<ResultsItem>("user")
        ...
        btn_play.setOnClickListener {
            val Intent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://www.youtube.com/results?search_query=" + user?.title)
            )
        ...
        //RV START
        val rvOYML = findViewById<RecyclerView>(R.id.rv_yml2)
